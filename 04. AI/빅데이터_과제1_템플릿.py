...
access_key="yZZgPPuDihT%2F%2BxPnqlmB43yjAdza8%2F23DVjtbXpxc5peeqF9Mu%2FADaBFPgXYSxzXG6pXJtdQJzUdiFIVQMsg4Q%3D%3D" #본인의 access_key를 입력하세요.
...
def make_base_dir():
   os.makedirs('.' + dir_delimeter + repo_base_name)

def make_d2_dir(dir_num):
   os.makedirs('.' + dir_delimeter + repo_base_name + dir_delimeter + depth_level2_dir + dir_num)
